...
run.py|Entry point of the entire app
gui4.py|Window with mmost of the code and is shown after a successfull login
report.py|Window that is opened when interacting with report button, responsible for reporting items
found.py|Window for inputed found items
dbinformation.py|Main database connections
colours.py|Colours constants used across all windows
setup_db.py|Script used one time to create database tables 
